...
const Unit4_Page4_WritingA = () => {
  const correctAnswers = [
    "She spends most of her time in school.",
    "She spends fifteen minutes bothering her brother.",
  ];

  const questions = [
    "Where does the writer spend the most of her time?",
    "How many minutes does she spend annoying her brother?",
  ];
      ...
      <div className="space-y-8 text-[18px]">
        {questions.map((q, i) => (
          <div
            key={i}
            className={`${
              i === 1 ? "flex flex-col gap-2" : "flex items-center gap-4"
            }`}
          >
            {/* السؤال الأول */}
            {i === 0 ? (
              <>
                ...
                <div className="relative flex-1 flex items-center">
                  <span className="mr-2 whitespace-nowrap">{q}</span>
                  ...
                  <input
                    ...
                    className={`border-b outline-none flex-1 text-[#6D2980] font-bold px-2 bg-transparent
...
export default Unit4_Page4_WritingA;
