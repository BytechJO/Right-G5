...
import page_3 from "../../../assets/imgs/pages/WB_Right_3/Right Int WB G3 U2 Folder/Page 14.png";
import "./WB_unit1.css";
...
const WB_Unit1_Page8 = ({ openPopup }) => {
  return (
    <div className="page1-img-wrapper"
      ...
      <div
        className="q12-2 hover:scale-110 transition"
        style={{ overflow: "visible" }}
      >
        <svg
          width="22"
     ...
     <div
        className="q13-2 hover:scale-110 transition"
        style={{ overflow: "visible" }}
      >
        <svg
          width="22"
