  ...
  const questions = [
    {
      ...
      answer: "No one was in the library.",
    },

    {
      hint: "(somebody, room)",

      answer: "Somebody is in the room.",
    },

    {
      hint: "(everybody, park)",

      answer: "Everybody wants to go to the park.",
    },

    {
      hint: "(anyone, at the door?)",

      answer: "Is anyone at the door?",
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center p-[30px]">
      <div className="div-forall text-[18px] w-full">
        ...
        <h5 className="header-title-page8 mb-[16vh]">
          <span
            className="ex-A"
            style={{
              marginRight: "10px",
          ...
          {questions.map((q, index) => (
            <div key={index}>
              <div className="flex items-center gap-3">
                ...
                <span className="whitespace-nowrap">{q.hint}</span>
              </div>
            </div>
          ))}
        </div>
